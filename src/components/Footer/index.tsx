...
const Footer = () => {
  return (
    <>
      <footer className="dark:bg-gray-dark relative z-10 bg-gray-cpm pt-16 md:pt-20 lg:pt-24">
          ...
          <div className="-mx-4 flex flex-wrap">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <div className="w-20 max-w-full pr-4">
                    ...
                    >
                      <Image
                        src="/images/logo/cpm_logo.png"
                        alt="logo"
                        width={140}
                        height={30}
                        className="dark:hidden w-full rounded-full"
                      />
                      <Image
                        src="/images/logo/cpm_logo.png"
                        alt="logo"
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-white">
                  Office:{" "}
                  <a
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="dark:text-body-color-dark dark:hover:text-primary mr-6 text-body-color duration-300 hover:text-primary"
                  >
                    <svg
                      width="18"
                      height="18"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="dark:text-body-color-dark dark:hover:text-primary text-body-color duration-300 hover:text-primary"
                  >
                    <svg
                      width="17"
                      height="16"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-6 lg:mb-12">
                <h2 className="dark:text-white mb-5 text-xl font-bold text-white">
                  CPMCD
                </h2>
                <ul>
                  <li>
