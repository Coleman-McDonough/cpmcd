    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${
          sticky
            ? "dark:bg-gray-dark dark:shadow-sticky-dark fixed z-[9999] bg-gray-cpm !bg-opacity-100 shadow-sticky backdrop-blur-sm transition"
            : "dark:bg-gray-dark dark:shadow-sticky-dark fixed z-[9999] bg-gray-cpm !bg-opacity-100 shadow-sticky backdrop-blur-sm transition" //"absolute bg-transparent"
        }`}
      >
